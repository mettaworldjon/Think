...
class SignUp: UIViewController {
    ...
    fileprivate func setupNav() {
        ...
        let spacer = UIBarButtonItem(barButtonSystemItem: .fixedSpace, target: self, action: #selector(handleSignUp))
        spacer.width = 20
        self.navigationItem.rightBarButtonItems = [spacer,signUpBtn]
    }
